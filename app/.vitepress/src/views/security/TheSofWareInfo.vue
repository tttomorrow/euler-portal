...
import OTable from 'opendesign/table/OTable.vue';
...
<template>
  <div class="wrapper">
    ...
    <div class="main-top">
      ...
      <a :href="configurationInfo.friendlyLink" class="link" target="_blank">{{
        configurationInfo.friendlyLink
      }}</a>
    </div>
      ...
      <div class="content">
        <div class="content-box">
          <p>
            ...
            <span class="content-item">{{ configurationInfo.osVersion }}</span>
          </p>
          <p>
            <span class="label">{{
    ...
    <div class="main-bottom">
      ...
      <div class="table-pc">
        <OTable :data="detailAapterList" style="width: 100%">
          <OTableColumn
            prop="driverName"
            :label="i18n.compatibility.HARDWARE_DETAIL.TABLE_CULUMN.DRIVE_NAME"
          ></OTableColumn>
          <OTableColumn
            prop="version"
          ...
          <OTableColumn
            prop="date"
            :label="i18n.compatibility.HARDWARE_DETAIL.TABLE_CULUMN.DRIVE_DATE"
          ></OTableColumn>
          <OTableColumn
            prop="chipVendor"
            :label="
              i18n.compatibility.HARDWARE_DETAIL.TABLE_CULUMN.DRIVE_CHIP_VENDOR
            "
          ></OTableColumn>
          <OTableColumn
            prop="boardModel"
            :label="
              i18n.compatibility.HARDWARE_DETAIL.TABLE_CULUMN.DRIVE_BOARD_MODEL
            "
          ></OTableColumn>
          <OTableColumn
            prop="chipModel"
