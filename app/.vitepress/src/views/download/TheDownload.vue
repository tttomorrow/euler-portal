      ...
      DOWNLOAD_LIST: [
        {
          ...
          EDGE_IMAGE:
            'https://repo.openeuler.org/openEuler-22.03-LTS/edge_img/',
          EMBEDDEN_IMAGE:
        ...
        },
        {
          ...
          SEEK_HELP_URL: 'https://gitee.com/openeuler/community-issue',
          GET_ISO_URL:
            'https://repo.openeuler.org/openEuler-20.03-LTS-SP3/ISO/',
          LIFE_CYCLE_URL: '/zh/other/lifecycle/',
        ...
        },
        {
          ...
          SEEK_HELP_URL: 'https://gitee.com/openeuler/community-issue',
          GET_ISO_URL:
            'https://repo.openeuler.org/openEuler-20.03-LTS-SP1/ISO/',
          LIFE_CYCLE_URL: '/zh/other/lifecycle/',
    ...
    en: {
      DOWNLOAD_LIST: [
        ...
        },
        {
          ...
          GET_ISO_URL: 'https://repo.openeuler.org/openEuler-21.03/ISO/',
          WHITE_PAPER:
            '/whitepaper/en/openEuler-21.03-Technical-White-Paper.pdf',
          LIFE_CYCLE_URL: '/en/other/lifecycle/',
      ...
      DOWNLOAD_LIST: [
        ...
        },
        {
          ...
          GET_ISO_URL:
            'https://repo.openeuler.org/openEuler-20.03-LTS-SP2/ISO/',
          LIFE_CYCLE_URL: '/ru/other/lifecycle/',
          WEBSITE_SELECT: '/ru/mirror/select/?version=20.03-LTS-SP2',
          MANUFACTURER: 'openEuler community',
          PUBLISH_DATE: '2021/07',
          LTS: true,
        },
...
<template>
  <div class="download">
    <div class="download-list">
      <OCard
        v-for="(download, index) in list.cn.DOWNLOAD_LIST"
        :key="index"
      ...
      >
        ...
        <div class="url-list">
          <div v-if="download.SEEK_HELP_URL ? true : false">
            <a target="_blank" :href="download.SEEK_HELP_URL"> 求助提问 </a>
          </div>
          <div v-if="download.GET_ISO_URL ? true : false">
            <a target="_blank" :href="download.GET_ISO_URL"> 获取ISO </a>
          </div>
          <div v-if="download.LIFE_CYCLE_URL ? true : false">
            <a target="_blank" :href="download.LIFE_CYCLE_URL"> 生命周期 </a>
          </div>
          <div v-if="download.RELEASE_DESC_URL ? true : false">
            <a target="_blank" :href="download.RELEASE_DESC_URL"> 发行说明 </a>
          </div>
          ...
          <div v-if="download.WHITE_PAPER ? true : false">
            <a target="_blank" :href="download.WHITE_PAPER"> 白皮书 </a>
          </div>
          <div v-if="download.WEBSITE_SELECT ? true : false">
            <a target="_blank" :href="download.WEBSITE_SELECT"> 站点选择 </a>
          </div>
        </div>
        <OButton
          size="small"
...
.url-list {
  ...
  grid-gap: var(--o-spacing-s2) var(--o-spacing-s3);
