...
export default {
  ...
  COPYRIGHT_1:
    '[Заявление об авторском праве]Copyright © 2023 openEuler Community. Данная статья была впервые опубликована сообществом openEuler. Пожалуйста, копируйте и распространяйте ее в соответствии с лицензией',
  COPYRIGHT_2:
